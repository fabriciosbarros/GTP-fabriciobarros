...
$query1 = "SELECT * FROM appointments INNER JOIN users ON appointments.customer_id = users.user_id WHERE users.user_email = '".$email."'";
...
<?php include ("list_bookings_content.php"); ?>
